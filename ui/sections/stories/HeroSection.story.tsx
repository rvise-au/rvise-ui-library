...
import { SimpleText } from '../page/simpleText/SimpleText';
...
export const SimpleHeroWithAddon = () => (
  <Section>
    <SimpleText minHeight="min-content" alignment="center/center" textBlock={textBlock} />
    <FeaturedBoxGroup
      cols={{
        base: 1,
        xs: 2,
...
export const SimpleHeroLeftAligned = () => (
  <Section beforeContent={<LeftTopBlurSpot />} afterContent={<RightBottomBlurSpot />}>
    <SimpleText minHeight="680px" alignment="left/center" textBlock={textBlock} />
  </Section>
);
